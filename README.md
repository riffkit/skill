...
This is the **official Riffkit agent skill**. Add it to your AI assistant (Claude Code, Cursor, OpenClaw, …) and just say *"riff this TikTok into mine"* — your agent drives the whole pipeline. Or use it in the browser at **[riffkit.ai](https://riffkit.ai)**.
...
Everything also runs in the browser — upload a clip or paste a TikTok link at **[riffkit.ai](https://riffkit.ai)**. Same backend, same post-ready output.
